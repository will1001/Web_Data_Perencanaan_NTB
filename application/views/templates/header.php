...
<nav class="nav-wraper indigo">
    <div class="container">
        ...
        <ul class="right hide-on-med-and-down">
            ...
            <li><a class="dropdown-trigger" href="#!" data-target="data_urusan_pilihan1"><i class="material-icons right">arrow_drop_down</i></a></li>
            <li><a class="dropdown-trigger" href="#!" data-target="data_urusan_wajib1"><i class="material-icons right">arrow_drop_down</i></a></li> -->
        </ul>
    </div>
</nav>
<ul class="sidenav" id="mobile-links">
    ...
    <li ><a href="<?= base_url()?>site/data_pilihan">Data Urusan Pilihan</a></li>
    <li ><a href="<?= base_url()?>site/data_wajib">Data Urusan Wajib</a></li>
            <!-- <li><a class="dropdown-trigger" href="#!" data-target="data_urusan_pilihan2">Data Urusan Pilihan<i class="material-icons right">arrow_drop_down</i></a></li>
            <li><a class="dropdown-trigger" href="#!" data-target="data_urusan_wajib2">Data Urusan Wajib<i class="material-icons right">arrow_drop_down</i></a></li> -->
</ul>
    <div id="main-app">
        <div class="container">
