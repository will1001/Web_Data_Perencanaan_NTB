<div class="row">
    ...
    <div class="input-field col s12 m12">
        ...
        <div v-if="kotak_sumber_data" class="kotak-sumber_data">
            ...
            <div @mousedown.prevent @click="pilihSumberData(sumber.nama_sumber)" class="isi-sumber_data" v-for="sumber in filter_sumber_data" :value="sumber.id">{{sumber.nama_sumber}}</div>
        </div>
